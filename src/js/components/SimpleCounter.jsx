...
const SimpleCounter = (prop) => {
    return(
        ...
        <div className="counter-display"> 
                            <button className="btn btn-warning"onClick={prop.onReset}>Reset</button>
            ...
            <button className="btn btn-danger"onClick={prop.onStop}>Stop</button>
    </div>
                <button className="btn btn-primary"onClick={prop.onStart}>Start</button>
